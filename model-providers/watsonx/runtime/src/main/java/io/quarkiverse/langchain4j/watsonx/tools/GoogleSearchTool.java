...
/**
 * Built-in tool to search for online trends, news, current events, real-time information or research topics.
 */
@Experimental
public class GoogleSearchTool {
     ...
     * @return {@link List} of {@link GoogleSearchToolResult} that contain the retrieved web page content.
     */
    public List<GoogleSearchToolResult> search(String input, Integer maxResults) throws BuiltinToolException {
