...
public abstract class WatsonxModel {
    ...
    final QuarkusPromptFormatter promptFormatter;
    ...
    public WatsonxModel(Builder builder) {
        ...
        if (builder.promptFormatter != null) {
            this.promptFormatter = new QuarkusPromptFormatter(builder.promptFormatter, builder.promptJoiner);
        } else {
    ...
    public QuarkusPromptFormatter getPromptFormatter() {
    ...
    protected String toInput(List<ChatMessage> messages) {
        return promptFormatter.format(messages);
    }
