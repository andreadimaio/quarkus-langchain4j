...
public class ChatAllPropertiesTest extends WireMockAbstract {
    ...
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.watsonx.builtin-tool.log-requests", "true")
            .overrideRuntimeConfigKey("quarkus.langchain4j.watsonx.builtin-tool.log-responses", "true")
