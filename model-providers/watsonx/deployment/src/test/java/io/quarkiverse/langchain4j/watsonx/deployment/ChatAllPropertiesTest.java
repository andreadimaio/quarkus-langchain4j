...
public class ChatAllPropertiesTest extends WireMockAbstract {
    ...
    static QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .overrideRuntimeConfigKey("quarkus.langchain4j.watsonx.chat-model.guided-choice", "1,2")
    ...
    void check_config() throws Exception {
        ...
        assertEquals(new TreeSet<>(Set.of("1", "2")), runtimeConfig.chatModel().guidedChoice().orElse(null));
