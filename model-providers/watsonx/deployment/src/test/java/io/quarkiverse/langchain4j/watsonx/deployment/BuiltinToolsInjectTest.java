...
public class BuiltinToolsInjectTest extends WireMockAbstract {
    ...
    @Test
    void testWebCrawlerTool() throws Exception {
        ...
        WebCrawlerToolResult result = webCrawlerTool.process("https://www.ibm.com/us-en");
    ...
    @Test
    void testGoogleSearchTool() throws Exception {
        ...
        List<GoogleSearchToolResult> results = googleSearchTool.search("What was the weather in Toronto on January 13th 2025?",
                3);
